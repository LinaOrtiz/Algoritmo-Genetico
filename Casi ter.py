# -*- coding: utf-8 -*-
"""
Created on Thu Jan 30 09:22:45 2020
...
def actualizar (Mejorx, Posicion, Mejorx2, Posicion2,fila):
   # Optimo=np.zeros(fila)
    Optimo2=1000000000000000000000000000000000000000000.0
    #Genes=Posicion(0,:)
    for i in range (0,fila):
        if Optimo2 > Mejorx(i):
            Optimo2=Mejorx(i)
           # Optimo= Posicion()
           # print("El mejor es: " + str (Optimo2)
            if Optimo2 > Mejorx2(i):
                Optimo2=Mejorx2(i)
               # print("El mejor es: " + str (Optimo2)
    return(Optimo2)
    
input("Ingrese tamaño de la matriz")
...
for i in range (z):
   ...
   # print("Los mejores genes finales son: "+ str (Posicion2))
    print('')
    print('El mejor es: ' + str (actualizar (Mejorx, Posicion, Mejorx2, Posicion2,fila)))
